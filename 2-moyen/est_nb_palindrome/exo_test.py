...
assert not est_nbr_palindrome(132213)
assert not est_nbr_palindrome(1327213)

assert est_nbr_palindrome(122345543221)
assert est_nbr_palindrome(1223457543221)
